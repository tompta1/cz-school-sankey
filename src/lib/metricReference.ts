...
const METRIC_DESCRIPTORS: Record<string, MetricDescriptor> = {
  ...
  justice_inmate: {
    ...
    description: 'Výdaje vězeňské služby vztažené k průměru stavů z měsíčních hlášení.',
    rationale: 'Průměr stavů k poslednímu dni měsíce; nejde o počet unikátních osob za rok.',
  },
  ...
  social_care_recipient: {
    ...
    perUnitLabel: 'prosincovou výplatu/rok',
    countLabel: 'prosincových výplat příspěvku',
    title: 'Roční Kč / prosincová výplata příspěvku',
    description: 'Roční výdaje na péči dělené počtem prosincových výplat; nejde o průměrnou výši dávky.',
  ...
  social_substitute_alimony_recipient: {
    ...
    perUnitLabel: 'prosincovou výplatu/rok',
    countLabel: 'prosincových výplat dávky',
    title: 'Roční Kč / prosincová výplata dávky',
    description: 'Roční výdaje na náhradní výživné dělené počtem prosincových výplat; nejde o průměrnou výši dávky.',
