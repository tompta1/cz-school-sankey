...
DEFAULT_URL = (
    "https://datanzis.uzis.gov.cz/data/NR-04-NRHZS/NR-04-23/"
    "Otevrena-data-NR-04-23-vykony-rok-mesic-zp.csv.gz"
)
DEFAULT_METADATA_URL = (
    "https://datanzis.uzis.gov.cz/data/NR-04-NRHZS/NR-04-23/"
    "Otevrena-data-NR-04-23-vykony-rok-mesic-zp.csv-metadata.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch NRHZS monthly claims by payer")
