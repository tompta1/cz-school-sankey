...
DATASET_CODE = "nrhzs_claims_provider_ico"
DEFAULT_URL = (
...
DEFAULT_METADATA_URL = (
    "https://datanzis.uzis.gov.cz/data/NR-04-NRHZS/NR-04-02/"
    "Otevrena-data-NR-04-02-vykony-ico.csv-metadata.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch NRHZS yearly claims by provider ICO")
